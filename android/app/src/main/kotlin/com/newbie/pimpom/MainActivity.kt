package com.newbie.pimpom

import android.content.Intent
import android.content.res.Configuration
import com.newbie.pimpom.plugin.AppLifecyclePlugin
import com.newbie.pimpom.plugin.InstalledAppsPlugin
import com.newbie.pimpom.plugin.PictureInPicturePlugin
import com.newbie.pimpom.plugin.ProcessInfoPlugin
import com.newbie.pimpom.plugin.VpnServicePlugin
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        if (requestCode == VpnServicePlugin.REQUEST_CODE) {
            ...
            val alertDialog = Intent(applicationContext, VpnAlertDialog::class.java)
                .setAction("com.newbie.pimpom.ProxyVpnService")
